...
<!-- NOTE FOR LYLE: Full title from the paper is "A Networks Perspective on Temporary Migration and Risk-Sharing".
     Replace img path with your chosen thumbnail.
     The one-line description above is adapted from your abstract — feel free to adjust. -->
...
[Read the paper (PDF)](/assets/pdf/migration.pdf)
